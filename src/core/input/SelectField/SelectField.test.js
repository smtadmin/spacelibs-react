...
it("Renders without any options or value", ()=> {
	...
	const elementMultiSelect = render(<SelectField {...blankProps} config={{options: [], isMultiple: true}}/>);
...
it("Renders with options only", ()=>{
	const element = render(<SelectField {...blankProps} config={{options: options}}/>);
...
it("Renders with value and options | Single Selection", ()=>{
	const element = render(<SelectField {...blankProps} value={[options[0]]} config={{options:options}}/>);
...
it("Doesn't crash when an option is selected | Single Select", ()=>{
	...
	const element = render(<SelectField {...blankProps} config={{options: options}} onValueChanged={mockValueChanged}/>);
