 ...
 * -----
 * Last Modified: Wednesday, 2nd March 2022 11:28 am
...
function getThemeWithOverride(override) {
  ...
  function mergeObjects(original, updated) {
    for (let attribute in updated) {
      if (
        original[attribute] == null ||
        typeof updated[attribute] !== 'object'
      ) {
...
const baseTheme = {
  palette: {
    ...
    text: {
      primary: '#F44336', // Was #00000087, used on Landing page top label and tile icon, probably elsewhere too
