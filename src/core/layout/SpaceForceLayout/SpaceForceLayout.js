...
class SpaceForceLayout extends React.Component {
     ...
     * @param {*} props SpaceForceLayout props
     */
    constructor(props) {
        super();
        ...
        this.footer = {
            ...
            bootstrap: {
                mobile:
                    "mobile-footer fixed-bottom d-md-none d-flex background-theme-main justify-content-between",
                desktop: "",
            },
    ...
    /**
     * Renders SpaceForceLayout component
     *
                    ...
                    <Header
                        ...
                        left={
                            <BootstrapWrapper
                                ...
                                bootstrap={this.header.left.desktop.bootstrap}
                        ...
                        center={
                            <BootstrapWrapper
                                ...
                                bootstrap={this.header.center.desktop.bootstrap}
                        ...
                        right={
                            <BootstrapWrapper
                                ...
                                bootstrap={this.header.right.desktop.bootstrap}
                    ...
                    <Header
                        ...
                        left={
                            <BootstrapWrapper
                                ...
                                bootstrap={this.header.left.mobile.bootstrap}
                        ...
                        center={
                            <BootstrapWrapper
                                ...
                                bootstrap={this.header.center.mobile.bootstrap}
                        ...
                        right={
                            <BootstrapWrapper
                                ...
                                bootstrap={this.header.right.mobile.bootstrap}
                    ...
                    <Footer
                        ...
                        left={
                            <BootstrapWrapper
                                ...
                                bootstrap={this.footer.left.desktop.bootstrap}
                        ...
                        center={
                            <BootstrapWrapper
                                ...
                                bootstrap={this.footer.center.desktop.bootstrap}
                        ...
                        right={
                            <BootstrapWrapper
                                ...
                                bootstrap={this.footer.right.desktop.bootstrap}
                    ...
                    <Footer
                        ...
                        left={
                            <BootstrapWrapper
                                ...
                                bootstrap={this.footer.left.mobile.bootstrap}
                        ...
                        center={
                            <BootstrapWrapper
                                ...
                                bootstrap={this.footer.center.mobile.bootstrap}
                        ...
                        right={
                            <BootstrapWrapper
                                ...
                                bootstrap={this.footer.right.mobile.bootstrap}
