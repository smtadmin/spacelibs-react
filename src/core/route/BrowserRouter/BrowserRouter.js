...
class BrowserRouter extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            userRoles: Array.isArray(props.userRoles)
                ? props.userRoles
                : [props.userRoles],
        ...
        this.state.routes.forEach((route) => {
            if (
                ...
                (route.roles.includes("*") ||
                    route.roles.some((r) => this.state.userRoles.includes(r)))
            ) {
                newValidRoutes.push(
     ...
     *
     * @returns {*} BrowserRouter component
        ...
        return (
            <ReactBrowserRouter>
                <Switch>
                    ...
                    {this.state.errorRoute && this.state.errorRoute}
                </Switch>
            </ReactBrowserRouter>
        );
    }
